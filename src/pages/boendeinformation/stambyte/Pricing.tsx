    ...
    // <div className="mx-auto max-w-7xl bg-white py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-24 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:space-y-0">
        {pricing.tiers.map((tier) => (
          ...
          >
            <div className="">
              <h3 className="text-xl font-semibold text-gray-900">Investeringskostnader</h3>
            ...
            {tier.kostnader.map((feature) => (
              ...
              <h3 className="text-xl font-semibold text-gray-500">{feature.namn}</h3>
              <p className="mt-4 flex items-baseline text-gray-900">
                <span className="text-4xl font-bold tracking-tight">{svFormat.format(feature.pris)}</span>
                <span className="ml-1 text-l font-semibold text-gray-700">{feature.enhet}</span>
              </p>
                </div>
            ))}
