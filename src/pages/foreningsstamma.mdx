import {Attachment, Body, Centered2} from '../components';
...
__Tid__: Mötet börjar kl:19.00 torsdagen 4/5

Registrering från och med 18.15 kom i tid.

Mer info om årsstämman och dagordning kommer som bilaga med årsredovisningen som delas ut senast 20/4.
...
<Attachment items={
    [
        {title: "Årsredovisning 2022", filename: "årsredovisning_2022_imatra.pdf", url: "/dokument/arsredovisning/2023/arsredovisning_2022_imatra.pdf"},
        {title: "Valberedningensförslag", filename: "valberedningen_2022.pdf", url: "/dokument/arsredovisning/2023/valberedningen_2023.pdf"},
        {title: "Motioner", filename: "motioner_2022.pdf", url: "/dokument/arsredovisning/2023/imatra_motioner_2023.pdf"},
        {title: "Fullmakt", filename: "fullmaktslankett.pdf", url: "/dokument/mallar/fullmaktslankett.pdf"}
    ]} />


## Dagordning för föreningsstämman 4/5:
...
export default (props) => {
  ...
  h2: props => <h2 className="text-2xl font-extrabold text-red-900 tracking-tight sm:text-3xl" {...props} />
    ...
    return <MDXProvider components={components} >
        ...
        summary="Kallelse till Brf. Imatras föreningstämma torsdagen 4/5 i Folkets Husby"
      >
               <main {...props} />
          </Centered2>
      </Body>
