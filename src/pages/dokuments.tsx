...
function År2023() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2022</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2020() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2020</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2019() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2019</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2018() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2018</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2017() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2017</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2016() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2016</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2015() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2015</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2014() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2014</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2013() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2013</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2012() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2012</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
...
function År2007() {
  return (
    <div className='overflow-hidden bg-white shadow sm:rounded-md'>
      <div className='border-b border-gray-200 bg-white px-4 py-5 sm:px-6'>
        <h2 className='text-lg font-medium leading-6 text-gray-900'>2007</h2>
      </div>
      <ul>
        <li className='border-gray-200'>
          <FullTest
